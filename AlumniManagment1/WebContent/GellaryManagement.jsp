...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<div style="background-color:white; height:42px;margin-left:250px; width:82.8%;">
	<h5 style="font-weight:275; padding-top:10px; margin-left:10px;"><i class="glyphicon glyphicon-user"></i> Alumni<strong style="font-size:15px;font-weight:100;"> // Manage Gellary </strong></h5> 
	</div>
	...
	<h5 style="font-weight:275; padding-top:8px; margin-left:10px; color:white"><strong style="font-size:15px;font-weight:100; color:white"> <i class="glyphicon glyphicon-edit"></i> Manage Gellary </strong>
	<!--PLUS START!-->
